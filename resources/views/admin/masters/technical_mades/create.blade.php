    ...
    <div class="max-w mx-auto p-4">
        <div class="breadcrumbs text-sm mb-3">
            <ul>
                ...
                <li>Create Technical Made</li>
            </ul>
        </div>

        <div class="flex justify-between items-center mb-4">
            <h1 class="text-2xl font-bold">Create New Technical Made</h1>
            <a href="{{ route('technical-mades.index') }}" class="btn btn-outline btn-neutral">Back to Technical Mades</a>
        </div>

        <div class="bg-white border border-gray-200 rounded-lg shadow-sm">
            <div class="p-6">
                <form method="POST" action="{{ route('technical-mades.store') }}">
                    @csrf
                    ...
                    <div class="flex justify-end mt-6">
                        <button type="submit" class="btn btn-outline btn-primary">Create Technical Made</button>
                    </div>
                </form>
            </div>
        </div>
