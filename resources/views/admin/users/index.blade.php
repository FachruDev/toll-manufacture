                                        ...
                                        <div class="flex space-x-2">
                                            ...
                                            @if(!$user->hasVerifiedEmail())
                                                <form method="POST" action="{{ route('users.send-verification', $user) }}" class="inline">
                                                    @csrf
                                                    <button type="submit" class="tooltip tooltip-top text-info hover:text-blue-600 transition duration-200 cursor-pointer" data-tip="Send Verification Email">
                                                        <x-bi-send class="w-6 h-6"/>
                                                    </button>
                                                </form>
                                            @endif
                                        </div>
