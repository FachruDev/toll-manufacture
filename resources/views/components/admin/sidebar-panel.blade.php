            ...
            <div class="collapse collapse-arrow">
                ...
                <div class="collapse-content" x-show="settingsOpen" x-transition>
                    <div class="space-y-1 pl-2">
                        ...
                        @can('view-product-char-groups')
                        <a href="{{ route('product-char-groups.index') }}"
                            class="flex items-center px-3 py-2 text-sm font-normal rounded-lg transition-colors {{ request()->routeIs('admin.masters.product-char-groups.*') ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-gray-100' }}">
                            <x-heroicon-o-chevron-right class="mx-2 p-1" />
                            <span class="sidebar-text">Product Char Groups</span>
                        </a>
                        @endcan
