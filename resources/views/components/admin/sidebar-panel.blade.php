...
<div class="h-full flex flex-col transition-all duration-300 ease-in-out" id="sidebar-content"
     x-data="{ homeOpen: true, settingsOpen: true, userManagementOpen: true }">
    <!-- Header -->
    ...
    <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
        ...
        <div class="space-y-1">
            <div class="collapse collapse-arrow">
                ...
                <div class="collapse-title flex items-center px-3 py-2 text-xs font-medium text-gray-500 uppercase tracking-wider sidebar-text min-h-0 p-0">
                    <button @click="homeOpen = !homeOpen" class="flex items-center w-full px-3 py-2 hover:bg-gray-50 rounded-lg transition-colors text-sm font-medium">
                ...
                <div class="collapse-content" x-show="homeOpen" x-transition>
                    <div class="space-y-1 pl-2">
                        <a href="{{ route('admin.dashboard') }}" class="flex items-center px-2 py-2 text-sm font-normal rounded-lg transition-colors {{ request()->routeIs('admin.dashboard') ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-gray-100' }}">
                            <x-heroicon-o-chevron-right class="mx-2 p-1"/>
                            <span class="sidebar-text">Dashboard</span>
                        </a>
                        <a href="#" class="flex items-center px-2 py-2 text-sm font-normal text-gray-700 rounded-lg hover:bg-gray-100 transition-colors">
                            <x-heroicon-o-chevron-right class="mx-2 p-1"/>
        ...
        <div class="space-y-1">
            <div class="collapse collapse-arrow">
                ...
                <div class="collapse-title flex items-center px-3 py-2 text-xs font-medium text-gray-500 uppercase tracking-wider sidebar-text min-h-0 p-0">
                    <button @click="settingsOpen = !settingsOpen" class="flex items-center w-full px-3 py-2 hover:bg-gray-50 rounded-lg transition-colors text-sm font-medium">
                ...
                <div class="collapse-content" x-show="settingsOpen" x-transition>
                    <div class="space-y-1 pl-2">
                        <a href="{{ route('admin.settings.mail.edit') }}" class="flex items-center px-3 py-2 text-sm font-normal rounded-lg transition-colors {{ request()->routeIs('admin.settings.mail.*') ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-gray-100' }}">
                            <x-heroicon-o-chevron-right class="mx-2 p-1"/>
        ...
        <div class="space-y-1">
            <div class="collapse collapse-arrow">
                ...
                <div class="collapse-title flex items-center px-3 py-2 text-xs font-medium text-gray-500 uppercase tracking-wider sidebar-text min-h-0 p-0">
                    <button @click="userManagementOpen = !userManagementOpen" class="flex items-center w-full px-3 py-2 hover:bg-gray-50 rounded-lg transition-colors text-sm font-medium">
