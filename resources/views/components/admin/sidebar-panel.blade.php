...
<div class="h-full flex flex-col transition-all duration-300 ease-in-out" id="sidebar-content">
    ...
    <div class="h-16 flex items-center justify-between px-4 border-b border-gray-200">
        <div id="sidebar-close" class="p-8 rounded-lg hover:bg-gray-100 transition-colors sidebar-text">
            <img src="images/sidebar_expanded.png" alt="expanded logo">
            <img src="images/sidebar_collapse.png" alt="collapsed logo">
        </div>
    </div>
    ...
    <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
        ...
        <div class="space-y-1">
            ...
            <a href="{{ route('admin.dashboard') }}" class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors {{ request()->routeIs('admin.dashboard') ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-gray-100' }}">
    ...
    <div class="p-4 border-t border-gray-200">
        <a href="{{ route('admin.profile.edit') }}" class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors {{ request()->routeIs('admin.profile.*') ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-gray-100' }}">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
            </svg>
            <span class="sidebar-text">My Profile</span>
        </a>
        <a href="{{ route('logout') }}" class="flex items-center px-3 py-2 mt-1 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-100 transition-colors">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
